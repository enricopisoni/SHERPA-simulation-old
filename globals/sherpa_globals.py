...
path_emission_cdf_test = './input/BCemis_emepV434_camsV42_SecEmis.nc'
...
# London_emepCams_0_100_FLIP.nc'
path_area_cdf_test = './input/emiRedOn_Germany.nc'
# reductions per precursor and macro sector
# user_reduction_GNFR_all.txt'
path_reduction_txt_test = './input/user_reduction_GNFR_PPM25.txt'
# path_reduction_txt_test = '../input_CAMS42_EMEP/createRedText/user_reduction_GNFR_PPM10.txt'#user_reduction_GNFR_all.txt'
path_reduction50all_txt_test = './input/user_reduction_GNFR_50p.txt'
...
path_model_cdf_test = './input/SR_SURF_ug_PM25_rh50_SecEmi.nc'
...
# 0 if you do not need downscale, 1 if you need downscale but only for PM concentrations
downscale_request = 0
...
path_base_conc_cdf_test = './input/BCconc_emepV434_camsv42_SURF_ug_PM25_rh50.nc'
